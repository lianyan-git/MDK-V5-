...
TARGETS = {
    "Bootloader": {
        ...
        "entry_name": "boot_main.c",
        "entry_path": r"..\..\bootloader\boot_main.c",
        "sources": (
            ("Bootloader", "boot_updater.c", 1, r"..\..\bootloader\boot_updater.c"),
            ("Bootloader", "boot_jump.c", 1, r"..\..\bootloader\boot_jump.c"),
            ("Bootloader", "boot_recovery.c", 1, r"..\..\bootloader\boot_recovery.c"),
            ("Bootloader", "boot_platform_stm32.c", 1, r"..\..\bootloader\boot_platform_stm32.c"),
